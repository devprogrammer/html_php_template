  ...
  <div class="container mt-5 maxheight-container" style="max-width: 950px">
    <div class="row mt-4 d-flex flex-column-reverse flex-md-row">
      <div class="col-md-6 p-4 mr-lg-6">
        ...
        <form method="POST" novalidate class="needs-validation" action="/online/creditcards/registration">
      ...
      <div class="col-md-6 mb-3 d-flex justify-content-center align-items-center p-0 px-lg-3">
        <img style="max-height: 132px" src="/assets/media/laptop-phone-paperplane.png" alt="Illustration">
      </div>
    </div>
  </div>
